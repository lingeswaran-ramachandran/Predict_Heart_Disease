# -*- coding: utf-8 -*-
"""
Created on Tue Jun 21 14:43:20 2022
...
with st.form("my_form"):
    st.write("This app is to predict the chance of a person having heart attack")
    
    age = int(st.number_input('Key in your age'))
    trtbps = int(st.number_input('Key in your resting blood pressure(in mm Hg on admission to the hospital'))
    ...
    if submitted:
        ...
        if outcome == 1:
            st.snow()
            st.write("High chance of getting heart attack.")
        else:
            st.balloons()
            st.write("Yeahhhhhhh...you have low risk of getting heart attack")      
